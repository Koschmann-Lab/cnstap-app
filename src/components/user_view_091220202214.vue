...
<template>
  <v-container>
    ...
    Bugs
    1. Scroll up after entering the tutorial view
    2. For the last step in tutorial, make the arrow point to the actual pdf and ppt buttons.
...
<!-- Print buttons for PDF and PPT - Start -->
        <div align="right" v-intro="'Click here to generate CNS-TAP report with Data table, Notes, and Graphs.'" v-intro-step="6">
