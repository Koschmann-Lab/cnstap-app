...
<!-- Main Drug Table - Print headers - End -->
    <template v-slot:body.prepend="{headers}">
        <tr><td class="grey darken-3 white--text text--center" v-for="(header,i) in headers" :key="i">
                ...
                <div v-else><!-- empty table cells for columns that don't need a sum --></div>
            </td></tr>
    </template>
...
import domtoimage from 'dom-to-image';
  ...
  export default {
    ...
    { pathways: "AKT", drugagents: "MK2206", vitro: 4, vivo: 6, safety: 6, cns: 0, bbb: 0, fda: 0, subt:16, icln: [0,1,2], itier: [0,1,2], itrl: [0,1,2], cln: 0, tier: 0, trl: 0, total: 16, editable: 1, },
    { pathways: "AKT", drugagents: "Perfinosine", vitro: 2, vivo: 0, safety: 6, cns: 0, bbb: 0, fda: 0, subt:8, icln: [0,1,2], itier: [0,1,2], itrl: [0,1,2], cln: 0, tier: 0, trl: 0, total: 8, editable: 0, },
    { pathways: "ALK", drugagents: "Ceritinib", vitro: 2, vivo: 0, safety: 6, cns: 0, bbb: 10, fda: 10, subt:28, icln: [0,1,2], itier: [0,1,2], itrl: [0,1,2], cln: 0, tier: 0, trl: 0, total: 28, editable: 1, },
    { pathways: "ALK", drugagents: "Alectinib", vitro: 2, vivo: 6, safety: 3, cns: 5, bbb: 10, fda: 0, subt:26, icln: [0,1,2], itier: [0,1,2], itrl: [0,1,2], cln: 0, tier: 0, trl: 0, total: 26, editable: 0, },
    { pathways: "ALK", drugagents: "Entrectinib", vitro: 4, vivo: 0, safety: 3, cns: 10, bbb: 10, fda: 0, subt:27, icln: [0,1,2], itier: [0,1,2], itrl: [0,1,2], cln: 0, tier: 0, trl: 0, total: 27, editable: 0, },
    { pathways: "BRAF", drugagents: "Dabrafenib", vitro: 4, vivo: 6, safety: 6, cns: 10, bbb: 5, fda: 10, subt:41,  icln: [0,1,2], itier: [0,1,2], itrl: [0,1,2], cln: 0, tier: 0, trl: 0,total: 41, editable: 1, },
    { pathways: "BRAF", drugagents: "Vemurafenib", vitro: 2, vivo: 0, safety: 0, cns: 10, bbb: 5, fda: 10, subt: 27, icln: [0,1,2], itier: [0,1,2], itrl: [0,1,2], cln: 0, tier: 0, trl: 0, total: 27, editable: 0, },
    { pathways: "CDK", drugagents: "Abemaciclib", vitro: 2, vivo: 6, safety: 0, cns: 10, bbb: 5, fda: 10, subt: 33, icln: [0,1,2], itier: [0,1,2], itrl: [0,1,2], cln: 0, tier: 0, trl: 0, total: 33, editable: 1, },
    { pathways: "CDK", drugagents: "Palbociclib", vitro: 4, vivo: 6, safety: 3, cns: 0, bbb: 0, fda: 10, subt: 23, icln: [0,1,2], itier: [0,1,2], itrl: [0,1,2], cln: 0, tier: 0, trl: 0, total: 23, editable: 0, },
    { pathways: "CDK", drugagents: "Ribociclib", vitro: 2, vivo: 0, safety: 6, cns: 0, bbb: 10, fda: 10, subt: 28, icln: [0,1,2], itier: [0,1,2], itrl: [0,1,2], cln: 0, tier: 0, trl: 0, total: 28, editable: 0, },
    { pathways: "CNS Generic", drugagents: "Lenalidomide", vitro: 2, vivo: 0, safety: 6, cns: 10, bbb: 10, fda: 10, subt: 38, icln: [0,1,2], itier: [0,1,2], itrl: [0,1,2], cln: 0, tier: 0, trl: 0, total: 38, editable: 1, },
    { pathways: "CNS Generic", drugagents: "Olaparib", vitro: 4, vivo: 6, safety: 0, cns: 5, bbb: 0, fda: 10, subt: 25, icln: [0,1,2], itier: [0,1,2], itrl: [0,1,2], cln: 0, tier: 0, trl: 0, total: 25, editable: 0, },
    { pathways: "CNS Generic", drugagents: "Gemcitabine", vitro: 4, vivo: 6, safety: 0, cns: 5, bbb: 10, fda: 10, subt: 35, icln: [0,1,2], itier: [0,1,2], itrl: [0,1,2], cln: 0, tier: 0, trl: 0, total: 35, editable: 0, },
    { pathways: "EGFR", drugagents: "Erlotinib", vitro: 4, vivo: 0, safety: 6, cns: -10, bbb: 10, fda: 10, subt: 20, icln: [0,1,2], itier: [0,1,2], itrl: [0,1,2], cln: 0, tier: 0, trl: 0, total: 20, editable: 1, },
    { pathways: "EGFR", drugagents: "Osimertinib Mesylate (AZD9291; Tagrisso)", vitro: 2, vivo: 6, safety: 0, cns: 5, bbb: 10, fda: 10, subt: 33, icln: [0,1,2], itier: [0,1,2], itrl: [0,1,2], cln: 0, tier: 0, trl: 0, total: 33, editable: 0, },
    { pathways: "FGFR", drugagents: "Pazopanib (FGFR)", vitro: 4, vivo: 6, safety: 6, cns: 5, bbb: 5, fda: 10, subt: 36, icln: [0,1,2], itier: [0,1,2], itrl: [0,1,2], cln: 0, tier: 0, trl: 0, total: 36, editable: 1, },
    { pathways: "FGFR", drugagents: "Ponatinib (FGFR)", vitro: 4, vivo: 6, safety: 0, cns: 5, bbb: 10, fda: 10, subt: 35, icln: [0,1,2], itier: [0,1,2], itrl: [0,1,2], cln: 0, tier: 0, trl: 0, total: 35, editable: 0, },
    { pathways: "FGFR", drugagents: "Erdafitinib (FGFR)", vitro: 4, vivo: 6, safety: 0, cns: 5, bbb: 0, fda: 0, subt: 15, icln: [0,1,2], itier: [0,1,2], itrl: [0,1,2], cln: 0, tier: 0, trl: 0, total: 15, editable: 0, },
    { pathways: "FGFR", drugagents: "Debio 1347 (FGFR)", vitro: 2, vivo: 1, safety: 0, cns: 0, bbb: 0, fda: 0, subt: 3, icln: [0,1,2], itier: [0,1,2], itrl: [0,1,2], cln: 0, tier: 0, trl: 0, total: 3, editable: 0, },
    { pathways: "EGFR/HER2/HER4/cMET", drugagents: "Afatinib", vitro: 4, vivo: 6, safety: 3, cns: -10, bbb: 0, fda: 10, subt: 13, icln: [0,1,2], itier: [0,1,2], itrl: [0,1,2], cln: 0, tier: 0, trl: 0, total: 13, editable: 1, },
    { pathways: "HDAC", drugagents: "Panobinostat (LBH589)", vitro: 2, vivo: 6, safety: 6, cns: 10, bbb: 0, fda: 10, subt: 34, icln: [0,1,2], itier: [0,1,2], itrl: [0,1,2], cln: 0, tier: 0, trl: 0, total: 34, editable: 1, },
    { pathways: "HDAC", drugagents: "Vorinostat (SAHA)", vitro: 2, vivo: 6, safety: 6, cns: -10, bbb: 10, fda: 10, subt: 24, icln: [0,1,2], itier: [0,1,2], itrl: [0,1,2], cln: 0, tier: 0, trl: 0, total: 24, editable: 0, },
    { pathways: "HDAC", drugagents: "Entinostat", vitro: 4, vivo: 6, safety: 3, cns: 0, bbb: 5, fda: 0, subt: 18, icln: [0,1,2], itier: [0,1,2], itrl: [0,1,2], cln: 0, tier: 0, trl: 0, total: 18, editable: 0, },
    { pathways: "HDAC", drugagents: "Onc201", vitro: 4, vivo: 6, safety: 3, cns: 10, bbb: 10, fda: 0, subt: 33, icln: [0,1,2], itier: [0,1,2], itrl: [0,1,2], cln: 0, tier: 0, trl: 0, total: 33, editable: 0, },
    { pathways: "HDAC", drugagents: "Valproic Acid", vitro: 4, vivo: 3, safety: 6, cns: 0, bbb: 10, fda: 10, subt: 33, icln: [0,1,2], itier: [0,1,2], itrl: [0,1,2], cln: 0, tier: 0, trl: 0, total: 33, editable: 0, },
    { pathways: "INI1", drugagents: "Alisertib (MLN8237)", vitro: 4, vivo: 6, safety: 6, cns: 10, bbb: 10, fda: 0, subt: 36, icln: [0,1,2], itier: [0,1,2], itrl: [0,1,2], cln: 0, tier: 0, trl: 0, total: 36, editable: 1, },
    { pathways: "INI1", drugagents: "Tamoxifen", vitro: 2, vivo: 0, safety: 0, cns: 0, bbb: 10, fda: 10, subt: 22, icln: [0,1,2], itier: [0,1,2], itrl: [0,1,2], cln: 0, tier: 0, trl: 0, total: 22, editable: 0, },
    { pathways: "INI1", drugagents: "Tazemetostat (EPZ-6438)", vitro: 2, vivo: 0, safety: 3, cns: 0, bbb: 5, fda: 0, subt: 10, icln: [0,1,2], itier: [0,1,2], itrl: [0,1,2], cln: 0, tier: 0, trl: 0, total: 10, editable: 0, },
    { pathways: "MEK", drugagents: "Trametinib", vitro: 2, vivo: 3, safety: 3, cns: 5, bbb: 10, fda: 10, subt: 33, icln: [0,1,2], itier: [0,1,2], itrl: [0,1,2], cln: 0, tier: 0, trl: 0, total:33 , editable: 1, },
    { pathways: "MEK", drugagents: "Selumetinib", vitro: 4, vivo: 0, safety: 0, cns: 0, bbb: 0, fda: 10, subt: 14, icln: [0,1,2], itier: [0,1,2], itrl: [0,1,2], cln: 0, tier: 0, trl: 0, total: 14, editable: 0, },
    { pathways: "MEK", drugagents: "Cobimetinib", vitro: 4, vivo: 0, safety: 0, cns: 0, bbb: 5, fda: 0, subt: 19, icln: [0,1,2], itier: [0,1,2], itrl: [0,1,2], cln: 0, tier: 0, trl: 0, total: 19, editable: 0, },
    { pathways: "MEK", drugagents: "Binimetinib", vitro: 4, vivo: 0, safety: 0, cns: 5, bbb: 0, fda: 10, subt: 19, icln: [0,1,2], itier: [0,1,2], itrl: [0,1,2], cln: 0, tier: 0, trl: 0, total: 19, editable: 0, },
    { pathways: "PDGFR", drugagents: "Crenolanib", vitro: 2, vivo: 0, safety: 3, cns: 0, bbb: 0, fda: 0, subt: 5, icln: [0,1,2], itier: [0,1,2], itrl: [0,1,2], cln: 0, tier: 0, trl: 0, total: 5, editable: 1, },
    { pathways: "PDGFR", drugagents: "Dasatinib", vitro: 4, vivo: 6, safety: 6, cns: 5, bbb: 10, fda: 10, subt: 41, icln: [0,1,2], itier: [0,1,2], itrl: [0,1,2], cln: 0, tier: 0, trl: 0, total: 41, editable: 0, },
    { pathways: "PDGFR", drugagents: "Pazopanib", vitro: 4, vivo: 6, safety: 6, cns: 5, bbb: 5, fda: 10, subt: 36, icln: [0,1,2], itier: [0,1,2], itrl: [0,1,2], cln: 0, tier: 0, trl: 0, total: 36, editable: 0, },
    { pathways: "PDGFR", drugagents: "Ponatinib (PDGFR)", vitro: 4, vivo: 6, safety: 0, cns: 5, bbb: 10, fda: 10, subt: 35, icln: [0,1,2], itier: [0,1,2], itrl: [0,1,2], cln: 0, tier: 0, trl: 0, total: 35, editable: 0, },
    { pathways: "PDGFR", drugagents: "Sorafenib", vitro: 2, vivo: 0, safety: 6, cns: 0, bbb: 0, fda: 10, subt: 18, icln: [0,1,2], itier: [0,1,2], itrl: [0,1,2], cln: 0, tier: 0, trl: 0, total: 18, editable: 0, },
    { pathways: "PDGFR", drugagents: "Sunitinib", vitro: 2, vivo: 6, safety: 6, cns: 5, bbb: 0, fda: 10, subt: 29, icln: [0,1,2], itier: [0,1,2], itrl: [0,1,2], cln: 0, tier: 0, trl: 0, total: 29, editable: 0, },
    { pathways: "PI3K/mTOR", drugagents: "BKM120 (Buparlisib)", vitro: 4, vivo: 6, safety: 0, cns: 0, bbb: 5, fda: 0, subt: 15, icln: [0,1,2], itier: [0,1,2], itrl: [0,1,2], cln: 0, tier: 0, trl: 0, total: 15, editable: 1, },
    { pathways: "PI3K/mTOR", drugagents: "GDC-0084 (PI3K Inhibitor)", vitro: 4, vivo: 0, safety: 0, cns: 10, bbb: 10, fda: 0, subt: 24, icln: [0,1,2], itier: [0,1,2], itrl: [0,1,2], cln: 0, tier: 0, trl: 0, total: 24, editable: 0, },
    { pathways: "PI3K/mTOR", drugagents: "Everolimus (PI3K)", vitro: 2, vivo: 0, safety: 6, cns: 10, bbb: 5, fda: 10, subt: 33, icln: [0,1,2], itier: [0,1,2], itrl: [0,1,2], cln: 0, tier: 0, trl: 0, total: 33, editable: 0, },
    { pathways: "PI3K/mTOR", drugagents: "Temsirolimus", vitro: 4, vivo: 6, safety: 6, cns: -5, bbb: 5, fda: 10, subt: 26, icln: [0,1,2], itier: [0,1,2], itrl: [0,1,2], cln: 0, tier: 0, trl: 0, total: 26, editable: 0, },
    { pathways: "PI3K/mTOR", drugagents: "LY3023414", vitro: 4, vivo: 3, safety: 0, cns: 5, bbb: 5, fda: 0, subt: 17, icln: [0,1,2], itier: [0,1,2], itrl: [0,1,2], cln: 0, tier: 0, trl: 0, total: 17, editable: 0, },
    { pathways: "MET", drugagents: "Crizotinib", vitro: 4, vivo: 6, safety: 6, cns: 5, bbb: 0, fda: 10, subt: 31, icln: [0,1,2], itier: [0,1,2], itrl: [0,1,2], cln: 0, tier: 0, trl: 0, total: 31, editable: 1, },
    { pathways: "MET/VEGF2", drugagents: "Cabozantinib", vitro: 4, vivo: 6, safety: 6, cns: 10, bbb: 10, fda: 10, subt: 46, icln: [0,1,2], itier: [0,1,2], itrl: [0,1,2], cln: 0, tier: 0, trl: 0, total: 46, editable: 1, },
    { pathways: "Chk1", drugagents: "Prexasertib", vitro: 2, vivo: 6, safety: 0, cns: 0, bbb: 0, fda: 0, subt: 8, icln: [0,1,2], itier: [0,1,2], itrl: [0,1,2], cln: 0, tier: 0, trl: 0, total: 8, editable: 1, },
    { pathways: "GENERIC CYTOTOXIC", drugagents: "Etoposide", vitro: 4, vivo: 6, safety: 6, cns: 10, bbb: 0, fda: 10, subt: 36, icln: [0,1,2], itier: [0,1,2], itrl: [0,1,2], cln: 0, tier: 0, trl: 0, total: 36, editable: 1, },
    { pathways: "GENERIC CYTOTOXIC", drugagents: "Carboplatin", vitro: 4, vivo: 6, safety: 6, cns: 10, bbb: 0, fda: 10, subt: 36, icln: [0,1,2], itier: [0,1,2], itrl: [0,1,2], cln: 0, tier: 0, trl: 0, total: 36, editable: 0, },
    { pathways: "GENERIC CYTOTOXIC", drugagents: "Irinotecan", vitro: 4, vivo: 6, safety: 6, cns: 10, bbb: 0, fda: 10, subt: 36, icln: [0,1,2], itier: [0,1,2], itrl: [0,1,2], cln: 0, tier: 0, trl: 0, total: 36, editable: 0, },
    { pathways: "GENERIC CYTOTOXIC", drugagents: "CCNU (lomustine)", vitro: 4, vivo: 3, safety: 6, cns: 10, bbb: 0, fda: 10, subt: 33, icln: [0,1,2], itier: [0,1,2], itrl: [0,1,2], cln: 0, tier: 0, trl: 0, total: 33, editable: 0, },
    { pathways: "GENERIC CYTOTOXIC", drugagents: "Temozolomide", vitro: 4, vivo: 6, safety: 6, cns: 10, bbb: 0, fda: 10, subt: 36, icln: [0,1,2], itier: [0,1,2], itrl: [0,1,2], cln: 0, tier: 0, trl: 0, total: 36, editable: 0, },
    { pathways: "RET", drugagents: "Ponatinib (RET)", vitro: 4, vivo: 6, safety: 0, cns: 5, bbb: 10, fda: 10, subt: 35, icln: [0,1,2], itier: [0,1,2], itrl: [0,1,2], cln: 0, tier: 0, trl: 0, total: 35, editable: 1, },
    { pathways: "RET", drugagents: "Cabozantinib", vitro: 4, vivo: 6, safety: 6, cns: 10, bbb: 10, fda: 10, subt: 46, icln: [0,1,2], itier: [0,1,2], itrl: [0,1,2], cln: 0, tier: 0, trl: 0, total: 46, editable: 0, },
    { pathways: "RET", drugagents: "Alectinib (RET)", vitro: 2, vivo: 0, safety: 0, cns: 5, bbb: 10, fda: 10, subt: 27, icln: [0,1,2], itier: [0,1,2], itrl: [0,1,2], cln: 0, tier: 0, trl: 0, total: 27, editable: 0, },
    { pathways: "RET", drugagents: "Loxo-292", vitro: 2, vivo: 6, safety: 3, cns: 5, bbb: 10, fda: 0, subt: 26, icln: [0,1,2], itier: [0,1,2], itrl: [0,1,2], cln: 0, tier: 0, trl: 0, total: 26, editable: 0, },
    { pathways: "RET", drugagents: "BLU-667", vitro: 2, vivo: 3, safety: 0, cns: 5, bbb: 0, fda: 0, subt: 10, icln: [0,1,2], itier: [0,1,2], itrl: [0,1,2], cln: 0, tier: 0, trl: 0, total: 10, editable: 0, } ],
...
// Do not show the first dummy row, if switch3 is not selected
    ...
    methods:{
       ...
       domtoimage.toPng(document.getElementById('pathwayGraph'))
        ...
        updateICLN: function(label,pPathway){
            for (var d = 0; d < this.drugs.length; d++){
                if(this.drugs[d].pathways.trim() == pPathway){
                      if (this.drugs[d].editable === 0) {
                          this.drugs[d].icln = label;
                      }
                      this.drugs[d].cln = Number(label)*5;
        ...
        updateITIER: function(label,pPathway){
            for (var d = 0; d < this.drugs.length; d++){
                if(this.drugs[d].pathways.trim() == pPathway){
                      if (this.drugs[d].editable === 0) {
                          this.drugs[d].itier = label;
                      }
                      this.drugs[d].tier = Number(label)*3;
                      this.drugs[d].total = Number(this.drugs[d].subt) + Number(this.drugs[d].cln) + Number(this.drugs[d].tier) + Number(this.drugs[d].trl);
                }
            }
            this.switch2=false;
        ...
        updateITRL: function(label,pPathway,pSUBT){
            for (var d = 0; d < this.drugs.length; d++){
                if((this.drugs[d].pathways.trim() == pPathway) && (this.drugs[d].subt == pSUBT)){
                      this.drugs[d].trl = Number(label)*20;
                      this.drugs[d].total = Number(this.drugs[d].subt) + Number(this.drugs[d].cln) + Number(this.drugs[d].tier) + Number(this.drugs[d].trl);
                }
            }
            this.switch2=false;
