    ...
    <div id="pathwayGraph" v-if="switch2">
        ...
        :key="testsetObj.pathway">
          ...
          <td class="lightblueleft">
            ...
            <tbody>
              <tr>
                <td class="lightblueleft">{{ testsetObj.pathway }}</td>
                <td class="lightbluecenter"></td>
                <td class="lightbluecenter"></td>
                <td class="lightbluecenter"></td>
                <td class="lightbluecenter"></td>
                <td class="lightbluecenter"></td>
                <td class="lightbluecenter"></td>
                <td class="lightblueright">Legend:</td>
                <td width="150px" class="lightblueleft"><div style="width:30px;height:10px;border:1px;solid #000;background:black;"></div>Baseline</td>
                <td class="lightblueleft"><div style="width:30px;height:10px;border:1px solid #000;background:white;"></div>Patient Specific</td>
              </tr>
...
import printJS from 'print-js';
  ...
  export default {
    ...
    { pathways: "AKT", drugagents: "MK2206", vitro: 4, vivo: 6, safety: 6, cns: 0, bbb: 0, fda: 0, subt:16, icln: 2, itier: 5, itrl: 10, cln: 2, tier: 5, trl: 10, total: 33, editable: 1, },
    { pathways: "AKT", drugagents: "Perfinosine", vitro: 2, vivo: 0, safety: 6, cns: 0, bbb: 0, fda: 0, subt:8, icln: 2, itier: 5, itrl: 10,  cln: 2, tier: 5, trl: 10, total: 20, editable: 0, },
    { pathways: "ALK", drugagents: "Ceritinib", vitro: 2, vivo: 0, safety: 6, cns: 0, bbb: 10, fda: 10, subt:28, icln: 4, itier: 0, itrl: 20,  cln: 4, tier: 0, trl: 20, total: 52, editable: 1, },
    { pathways: "ALK", drugagents: "Alectinib", vitro: 2, vivo: 6, safety: 3, cns: 5, bbb: 10, fda: 0, subt:26, icln: 4, itier: 0, itrl: 5,  cln: 4, tier: 0, trl: 5, total: 35, editable: 0, },
    { pathways: "ALK", drugagents: "Ponatinib", vitro: 4, vivo: 0, safety: 3, cns: 10, bbb: 10, fda: 0, subt:27, icln: 4, itier: 0, itrl: 10,  cln: 4, tier: 0, trl: 10, total: 41, editable: 0, },
        ...
        updateITIER(pPathway,pITIER){
            for (var d = 0; d < this.drugs.length; d++){
                if(this.drugs[d].pathways.trim() == pPathway){
                      ...
                      this.drugs[d].tier = Number(pITIER);
                      this.drugs[d].total = Number(this.drugs[d].subt) + Number(this.drugs[d].cln) + Number(this.drugs[d].tier) + Number(this.drugs[d].trl);
                }
            }
            this.switch2=false;
